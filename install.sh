  ...
  while true; do
    ...
    case "$SELECT_THEME" in
      ...
      2)
        ...
        ;;
      3)
        THEME_URL=$(echo -e "https://github.com/miftah12345678/hamstore/raw/main/custom_install_enigma.zip")
        break
        ;; 
      x)
        return
