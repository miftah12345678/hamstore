...
```bash
bash <(curl -s https://raw.githubusercontent.com/hamstore/pterodactyl-auto-installer/main/install.sh)
```

_Note: jika mengalami kesalahan atau kegagalan, unistall thema terlebih dahulu kemudia intsall kembali themanya._

masih bingung dengan cara pakainya ? [YouTube video](https://www.youtube.com/@hamstore23
